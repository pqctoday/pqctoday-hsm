...
#define P11PROV_NAMES_SLH_DSA_SHA2_128F \
    "SLH-DSA-SHA2-128f:SLHDSA_SHA2_128F:id-slh-dsa-sha2-128f:2.16.840.1.101.3.4.3.20"
#define P11PROV_DESCS_SLH_DSA_SHA2_128F "PKCS11 SLH-DSA-SHA2-128f implementation"
#define P11PROV_NAMES_XMSS "XMSS"
#define P11PROV_DESCS_XMSS "PKCS11 XMSS implementation (Verify Only)"
#define P11PROV_NAMES_XMSSMT "XMSSMT:XMSS-MT"
#define P11PROV_DESCS_XMSSMT "PKCS11 XMSSMT implementation (Verify Only)"
#define P11PROV_NAMES_LMS "LMS"
#define P11PROV_DESCS_LMS "PKCS11 LMS implementation (Verify Only)"
#define P11PROV_NAMES_HSS "HSS/LMS:HSSLMS:HSS-LMS:HSS"
#define P11PROV_DESCS_HSS "PKCS11 HSS implementation (Verify Only)"
