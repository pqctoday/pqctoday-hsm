...
information in [SECURITY.md](SECURITY.md).
...
**1. Correction** — Private written warning, clarity on violation, request for apology.

**2. Warning** — Warning with consequences for continued behavior; no interaction with those involved for a specified period.
